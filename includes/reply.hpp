...
static const reply RPL_WHOISUSER = {"311", ""};
static const reply RPL_WHOISSERVER = {"312", " custom IRC server ircserv 1.0"};
static const reply RPL_WHOISOPERATOR = {"313", "is an IRC operator"};
