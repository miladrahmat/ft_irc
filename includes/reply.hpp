...
static const reply RPL_ISUPPORT = {"005", "CHANTYPES=# NICKLEN=15 PREFIX=(o)@ CHANMODES=klit CHANLIMIT=#:50 TOPICLEN=390 :are supported by this server"};
...
static const reply ERR_NOORIGIN = {"409", "No origin specified"};
